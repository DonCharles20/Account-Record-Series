...
public class CreateSequentialFile extends JFrame {
	...
	public CreateSequentialFile() {
		...
		userInterface = new BankUI(9);//////////////////////////////////////////////STEP 6
	...
	private void openFile() {
		...
		// \ into
		// @"c:\java\date\r.dat" into "c:\\java\\data\\r.dat"
	...
	public void addRecord() {
		...
		if (!fieldValues[BankUI.ACCOUNT].equals("")) {
			...
			try {
				...
				sex = fieldValues[BankUI.SEX].charAt(0);
				gpa = Double.parseDouble(fieldValues[BankUI.GPA]);
